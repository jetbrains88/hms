                            ...
                            <tr class="hover:bg-blue-50/50 transition-colors duration-200">
                                ...
                                <td class="px-5 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex flex-col space-y-2 min-w-[120px]">
                                        ...
                                        <!-- Edit Button -->
                                        <a :href="`/laboratory/reports/${report.id}/edit`"
                                        ...
                                        <template x-if="report.status === 'completed'">
                                            <a :href="`/laboratory/reports/${report.id}/print`" target="_blank"
            ...
            Alpine.data('labReportsIndex', () => ({
                ...
                async fetchReports() {
                    ...
                    try {
                        ...
                        const response = await fetch(`/laboratory/reports/data?${params}`);
                ...
                async fetchStats() {
                    try {
                        const response = await fetch('/laboratory/statistics');
                        if (response.ok) {
                ...
                async confirmDeleteAction() {
                    ...
                    try {
                        const response = await fetch(
                            `/laboratory/reports/${this.reportToDelete.id}`, {
                                method: 'DELETE',
                                headers: {
