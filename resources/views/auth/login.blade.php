...
<div
    ...
    <div class="md:w-1/2 animated-bg p-12 flex flex-col justify-between relative text-white">
        <div
            class="absolute top-0 left-0 w-32 h-32 bg-white opacity-10 rounded-full mix-blend-overlay filter blur-xl -translate-x-1/2 -translate-y-1/2"></div>
        <div
            class="absolute bottom-0 right-0 w-64 h-64 bg-white opacity-10 rounded-full mix-blend-overlay filter blur-2xl translate-x-1/3 translate-y-1/3"></div>
        ...
        <div class="relative z-10">
            ...
            <h1 class="text-4xl font-bold mb-2">MedCare<span class="font-light opacity-80">+</span></h1>
        ...
        <div class="relative z-10">
            <div class="space-y-4">
                ...
                <div class="flex items-center gap-3 bg-white/10 p-3 rounded-lg backdrop-blur-sm border border-white/10">
                ...
                <div class="flex items-center gap-3 bg-white/10 p-3 rounded-lg backdrop-blur-sm border border-white/10">
                    ...
                    <div class="flex-1">
                        <span class="text-sm font-medium">MedCare Pharmacy Inventory</span>
                        {{--                        <div class="text-xs text-white/60 mt-1">Low stock: 8 items | Expiring soon: 12 meds</div>--}}
                        <div class="text-xs text-white-200 italic mt-1">"Real-time tracking prevents shortages"</div>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-3 bg-white/10 p-3 rounded-lg backdrop-blur-sm border border-white/10">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="text-xs text-white-200 italic mt-1">"Seamless diagnostics at your fingertips"</div>
                    </div>
                </div>
            </div>
        </div>

        <p class="text-xs text-blue-200 mt-8 relative z-10">© 2025 MedCare Systems. Secure Login.</p>
    </div>
    ...
    <div class="md:w-1/2 p-12 bg-white flex flex-col justify-center relative">
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                ...
                <a href="#" class="text-sm text-blue-600 font-semibold hover:text-blue-700 hover:underline">Forgot
                    Password?</a>
            </div>
...
<div class="fixed top-0 left-0 w-full h-full -z-10 bg-gray-50 overflow-hidden">
    <div
        class="absolute -top-[10%] -left-[10%] w-[40%] h-[40%] rounded-full bg-blue-200 mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
    <div
        class="absolute top-[20%] -right-[10%] w-[40%] h-[40%] rounded-full bg-cyan-200 mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-2000"></div>
    <div
        class="absolute -bottom-[20%] left-[20%] w-[40%] h-[40%] rounded-full bg-purple-200 mix-blend-multiply filter blur-3xl opacity-30 animate-blob animation-delay-4000"></div>
</div>
