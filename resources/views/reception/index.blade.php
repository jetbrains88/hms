...
@section('title', 'Reception Dashboard - SHM')
@section('page-title', 'Reception Desk')
    ...
    <div class="mt-8 grid lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-100 overflow-hidden">
                ...
                <div class="p-6">
                    <!-- New Patient Form -->
                    <form action="{{ route('reception.visits.store') }}" method="POST" id="newPatientForm"
                        ...
                        <div class="mb-6 p-4 border-2 border-dashed border-blue-200 rounded-lg bg-blue-50/30">
                            <div class="flex items-center">
                                <input type="checkbox" name="is_nhmp" id="is_nhmp"
                                    class="w-4 h-4 text-blue-600 rounded focus:ring-blue-500"
                                    x-model="newPatient.is_nhmp" @change="toggleNHMPFields">
                                <label for="is_nhmp" class="ml-2 font-bold text-gray-700 text-lg">
                                    <i class="fas fa-address-book mr-2 text-blue-600"></i>
                                    This patient is NHMP staff
                                </label>
                            </div>

                            <!-- NHMP Fields -->
                            <div x-show="newPatient.is_nhmp" x-transition class="mt-4 space-y-4">
                                <div class="grid md:grid-cols-2 gap-4">
                                    <div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="grid md:grid-cols-2 gap-6">
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-1">Pain Scale
                                            (0-10)</label>
                                        <input type="range" name="pain_scale" min="0" max="10"
                                ...
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 mb-1">Clinical
                                        Notes</label>
                                    <textarea name="notes" rows="3" x-model="newPatient.vitals.notes"
                                        class="w-full px-4 py-2.5 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition"
        ...
        return {
            ...
            async openPatientModal(patientData) {
                try {
                    ...
                    const url = `${baseUrl}/reception/visit/${patientData.id}/vitals`;
            ...
            async updatePatientStatus() {
                ...
                try {
                    ...
                    const baseUrl = window.location.origin;
                    const url = `${baseUrl}/reception/visit/${this.modalData.visit_id}/update`;
