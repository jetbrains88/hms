        ...
        <div class="bg-white rounded-2xl shadow-soft p-6">
            ...
            <div class="grid grid-cols-2 gap-6">
                <div>
                    ...
                    <p class="font-medium text-slate-800">{{ $labOrder->patient->name }}</p>
                    <p class="text-sm text-slate-500">EMRN: {{ $labOrder->patient->emrn }}</p>
                    <p class="text-sm text-slate-500">DOB: {{ $labOrder->patient->dob->format('d M Y') }}</p>
                </div>
                
                <div>
                    <p class="text-xs text-slate-400 uppercase">Ordered By</p>
                    <p class="font-medium text-slate-800">Dr. {{ $labOrder->doctor->name }}</p>
                ...
                <div class="col-span-2">
                    ...
                    <p class="font-medium text-slate-800">{{ $labOrder->verifiedBy->name }}</p>
